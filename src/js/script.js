...
personagens.forEach((personagem) => {
  personagem.addEventListener("mouseenter", () => {
    ...
    const personagemSelecionado = document.querySelector(".selecionado"); //busca um elemento que tenha a class selecionado
    personagemSelecionado.classList.remove("selecionado");

    personagem.classList.add("selecionado"); // adicionar class no html
  });
});
